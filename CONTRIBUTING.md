# Contributing to Instrument Script Server

Help wanted! We'd love your contributions to Instrument Script Server.
...
New issues can be created with in our [GitHub repo](https://github.com/falcon-autotuning/instrument-script-server/issues/new).
...
By contributing your code, you agree to license your contribution under the terms of the [MPL License](LICENSE).

All files are released with the MPL license.
