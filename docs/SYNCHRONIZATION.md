...
<!--toc:start-->
- [Instrument Synchronization Protocol](#instrument-synchronization-protocol)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
    - [Key Features](#key-features)
  - [Motivation](#motivation)
    - [Problem:  Timing Skew Without Synchronization](#problem-timing-skew-without-synchronization)
    - [Solution: Synchronized Parallel Execution](#solution-synchronized-parallel-execution)
  - [Protocol Design](#protocol-design)
    - [Sync Token System](#sync-token-system)
    - [Message Types](#message-types)
    - [Protocol Flow](#protocol-flow)
  - [Implementation](#implementation)
    - [RuntimeContext (Server Side)](#runtimecontext-server-side)
      - [Parallel Block Detection](#parallel-block-detection)
      - [Command Buffering](#command-buffering)
      - [Parallel Execution](#parallel-execution)
    - [SyncCoordinator (Server Side)](#synccoordinator-server-side)
      - [Barrier Registration](#barrier-registration)
      - [ACK Handling](#ack-handling)
    - [Worker Process (Worker Side)](#worker-process-worker-side)
      - [Worker State](#worker-state)
      - [Sending SYNC_ACK](#sending-syncack)
    - [InstrumentWorkerProxy (Server Side)](#instrumentworkerproxy-server-side)
      - [Handling SYNC_ACK](#handling-syncack)
      - [Broadcasting SYNC_CONTINUE](#broadcasting-synccontinue)
  - [Usage in Lua Scripts](#usage-in-lua-scripts)
    - [Basic Parallel Block](#basic-parallel-block)
    - [Parallel Read and Write](#parallel-read-and-write)
    - [Nested Loops with Sync](#nested-loops-with-sync)
    - [Conditional Parallel Execution](#conditional-parallel-execution)
  - [Performance](#performance)
    - [Overhead Measurements](#overhead-measurements)
    - [Scaling](#scaling)
  ...
  - [Troubleshooting](#troubleshooting)
    - [Problem: Parallel block never completes](#problem-parallel-block-never-completes)
    - [Problem: Commands execute sequentially despite parallel()](#problem-commands-execute-sequentially-despite-parallel)
    - [Problem: SYNC_ACK timeout](#problem-syncack-timeout)
    - [Problem: Incorrect timing despite sync](#problem-incorrect-timing-despite-sync)
  - [Advanced Topics](#advanced-topics)
    - [Multiple Parallel Blocks](#multiple-parallel-blocks)
    - [Partial Instrument Participation](#partial-instrument-participation)
    - [Error Handling in Parallel Blocks](#error-handling-in-parallel-blocks)
  - [See Also](#see-also)
<!--toc:end-->
