...
- [Instrument Server Architecture](#instrument-script-server-architecture)
  ...
  - [Process Model](#process-model)
    - [Server Daemon Process](#server-daemon-process)
    - [Worker Processes](#worker-processes)
    - [Command Processes](#command-processes)
  - [Core Components](#core-components)
    - [ServerDaemon](#serverdaemon)
    - [InstrumentRegistry](#instrumentregistry)
    - [InstrumentWorkerProxy](#instrumentworkerproxy)
    - [SyncCoordinator](#synccoordinator)
  - [IPC Communication](#ipc-communication)
    - [Transport:  Shared Memory Queues](#transport-shared-memory-queues)
...
**Implementation**: `src/worker_main.cpp`
